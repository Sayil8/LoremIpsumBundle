...
$b = new \Symfony\Component\HttpKernel\Config\FileLocator(($this->services['kernel'] ?? $this->get('kernel', 1)), (\dirname(__DIR__, 4).'\\Controller/Resources'), [0 => (\dirname(__DIR__, 4).'\\Controller')], false);
...
$a->addLoader(new \Symfony\Component\Routing\Loader\ContainerLoader(new \Symfony\Bundle\FrameworkBundle\Routing\LegacyRouteLoaderContainer($this, new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    'kernel' => 'SaaM\\LoremIpsumBundle\\Tests\\Controller\\SaaMLoremIpsumControllerKernel',
]))));
