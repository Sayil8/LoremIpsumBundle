 ...
 * @final
 */
class ControllerSaaM_LoremIpsumBundle_Tests_Controller_SaaMLoremIpsumControllerKernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'saam_lorem_ipsum.ipsum_api_controller' => 'getSaamLoremIpsum_IpsumApiControllerService.php',
            'saam_lorem_ipsum.saam_ipsum' => 'getSaamLoremIpsum_SaamIpsumService.php',
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/ControllerSaaM_LoremIpsumBundle_Tests_Controller_SaaMLoremIpsumControllerKernelTestDebugContainer.xml'); break;
    ...
    {
        return [
            'kernel.root_dir' => (\dirname(__DIR__, 4).'\\Controller'),
            ...
            'kernel.bundles' => [
                'SaaMLoremIpsumBundle' => 'SaaM\\LoremIpsumBundle\\SaaMLoremIpsumBundle',
                'FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle',
            ],
            'kernel.bundles_metadata' => [
                'SaaMLoremIpsumBundle' => [
            ...
            'kernel.container_class' => 'ControllerSaaM_LoremIpsumBundle_Tests_Controller_SaaMLoremIpsumControllerKernelTestDebugContainer',
            ...
            'router.cache_class_prefix' => 'ControllerSaaM_LoremIpsumBundle_Tests_Controller_SaaMLoremIpsumControllerKernelTestDebugContainer',
